...
const AddressFromStorage = localStorage.getItem("ShippingInfo")?JSON.parse(localStorage.getItem("ShippingInfo")):"";
...
const initialState = {
  ...
  export const {addCartItems,removeItem,setPaymentInfo,setShippingInfo,setTotalPrice}=CartSlice.actions;
