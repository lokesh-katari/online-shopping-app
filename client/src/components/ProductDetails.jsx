          ...
          <div className="lg:w-4/5 mx-auto flex flex-wrap">
            ...
            <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
              ...
              <div className="flex">
                ...
                <button className= {productDetails.stock<1?"ml-auto rounded-md bg-red-600 px-3.5 py-1.5 text-base font-semibold leading-7 text-white cursor-not-allowed opacity-50 " :"ml-auto rounded-md bg-indigo-600 px-3.5 py-1.5 text-base font-semibold leading-7 text-white "}  >
